/*** Autogenerated by WIDL 1.6 from ../tarballs/dxvahd.idl - Do not edit ***/
...
typedef struct __WIDL_dxvahd_generated_name_00000002 {
    char dummy;
} D3DCOLOR;
#endif
#ifndef __IDXVAHD_Device_FWD_DEFINED__
...
typedef HRESULT ( STDMETHODCALLTYPE *PDXVAHDSW_CreateDevice )(IDirect3DDevice9Ex *pD3DDevice,HANDLE *phDevice);
typedef HRESULT ( STDMETHODCALLTYPE *PDXVAHDSW_ProposeVideoPrivateFormat )(HANDLE hDevice,D3DFORMAT *pFormat);
typedef HRESULT ( STDMETHODCALLTYPE *PDXVAHDSW_GetVideoProcessorDeviceCaps )(HANDLE hDevice,const DXVAHD_CONTENT_DESC *pContentDesc,DXVAHD_DEVICE_USAGE Usage,DXVAHD_VPDEVCAPS *pCaps);
typedef HRESULT ( STDMETHODCALLTYPE *PDXVAHDSW_GetVideoProcessorOutputFormats )(HANDLE hDevice,const DXVAHD_CONTENT_DESC *pContentDesc,DXVAHD_DEVICE_USAGE Usage,UINT Count,D3DFORMAT *pFormats);
typedef HRESULT ( STDMETHODCALLTYPE *PDXVAHDSW_GetVideoProcessorInputFormats )(HANDLE hDevice,const DXVAHD_CONTENT_DESC *pContentDesc,DXVAHD_DEVICE_USAGE Usage,UINT Count,D3DFORMAT *pFormats);
typedef HRESULT ( STDMETHODCALLTYPE *PDXVAHDSW_GetVideoProcessorCaps )(HANDLE hDevice,const DXVAHD_CONTENT_DESC *pContentDesc,DXVAHD_DEVICE_USAGE Usage,UINT Count,DXVAHD_VPCAPS *pCaps);
typedef HRESULT ( STDMETHODCALLTYPE *PDXVAHDSW_GetVideoProcessorCustomRates )(HANDLE hDevice,const GUID *pVPGuid,UINT Count,DXVAHD_CUSTOM_RATE_DATA *pRates);
typedef HRESULT ( STDMETHODCALLTYPE *PDXVAHDSW_SetVideoProcessBltState )(HANDLE hVideoProcessor,DXVAHD_BLT_STATE State,UINT DataSize,const void *pData);
typedef HRESULT ( STDMETHODCALLTYPE *PDXVAHDSW_CreateVideoProcessor )(HANDLE hDevice,const GUID *pVPGuid,HANDLE *phVideoProcessor);
typedef HRESULT ( STDMETHODCALLTYPE *PDXVAHDSW_DestroyDevice )(HANDLE hDevice);
typedef HRESULT ( STDMETHODCALLTYPE *PDXVAHDSW_GetVideoProcessorFilterRange )(HANDLE hDevice,DXVAHD_FILTER Filter,DXVAHD_FILTER_RANGE_DATA *pRange);
typedef HRESULT ( STDMETHODCALLTYPE *PDXVAHDSW_DestroyVideoProcessor )(HANDLE hVideoProcessor);
typedef HRESULT ( STDMETHODCALLTYPE *PDXVAHDSW_VideoProcessBltHD )(HANDLE hVideoProcessor,IDirect3DSurface9 *pOutputSurface,UINT OutputFrame,UINT StreamCount,const DXVAHD_STREAM_DATA *pStreams);
typedef HRESULT ( STDMETHODCALLTYPE *PDXVAHDSW_GetVideoProcessStreamStatePrivate )(HANDLE hVideoProcessor,UINT StreamNumber,DXVAHD_STREAM_STATE_PRIVATE_DATA *pData);
typedef HRESULT ( STDMETHODCALLTYPE *PDXVAHDSW_SetVideoProcessStreamState )(HANDLE hVideoProcessor,UINT StreamNumber,DXVAHD_STREAM_STATE State,UINT DataSize,const void *pData);
typedef HRESULT ( STDMETHODCALLTYPE *PDXVAHDSW_GetVideoProcessBltStatePrivate )(HANDLE hVideoProcessor,DXVAHD_BLT_STATE_PRIVATE_DATA *pData);
typedef HRESULT ( STDMETHODCALLTYPE *PDXVAHDSW_Plugin )(UINT Size,void *pCallbacks);
...
HRESULT STDMETHODCALLTYPE IDXVAHD_Device_CreateVideoSurface_Proxy(
    IDXVAHD_Device* This,
    UINT Width,
    UINT Height,
    D3DFORMAT Format,
    ...
    IDirect3DSurface9 **ppSurfaces,
    HANDLE *pSharedHandle);
void __RPC_STUB IDXVAHD_Device_CreateVideoSurface_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDXVAHD_Device_GetVideoProcessorDeviceCaps_Proxy(
    IDXVAHD_Device* This,
    DXVAHD_VPDEVCAPS *pCaps);
void __RPC_STUB IDXVAHD_Device_GetVideoProcessorDeviceCaps_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDXVAHD_Device_GetVideoProcessorOutputFormats_Proxy(
    IDXVAHD_Device* This,
    UINT Count,
    D3DFORMAT *pFormats);
void __RPC_STUB IDXVAHD_Device_GetVideoProcessorOutputFormats_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDXVAHD_Device_GetVideoProcessorInputFormats_Proxy(
    IDXVAHD_Device* This,
    UINT Count,
    D3DFORMAT *pFormats);
void __RPC_STUB IDXVAHD_Device_GetVideoProcessorInputFormats_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDXVAHD_Device_GetVideoProcessorCaps_Proxy(
    IDXVAHD_Device* This,
    UINT Count,
    DXVAHD_VPCAPS *pCaps);
void __RPC_STUB IDXVAHD_Device_GetVideoProcessorCaps_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDXVAHD_Device_GetVideoProcessorCustomRates_Proxy(
    IDXVAHD_Device* This,
    const GUID *pVPGuid,
    UINT Count,
    DXVAHD_CUSTOM_RATE_DATA *pRates);
void __RPC_STUB IDXVAHD_Device_GetVideoProcessorCustomRates_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDXVAHD_Device_GetVideoProcessorFilterRange_Proxy(
    IDXVAHD_Device* This,
    DXVAHD_FILTER Filter,
    DXVAHD_FILTER_RANGE_DATA *pRange);
void __RPC_STUB IDXVAHD_Device_GetVideoProcessorFilterRange_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDXVAHD_Device_CreateVideoProcessor_Proxy(
    IDXVAHD_Device* This,
    const GUID *pVPGuid,
    IDXVAHD_VideoProcessor **ppVideoProcessor);
void __RPC_STUB IDXVAHD_Device_CreateVideoProcessor_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IDXVAHD_VideoProcessor_SetVideoProcessBltState_Proxy(
    IDXVAHD_VideoProcessor* This,
    DXVAHD_BLT_STATE State,
    UINT DataSize,
    const void *pData);
void __RPC_STUB IDXVAHD_VideoProcessor_SetVideoProcessBltState_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDXVAHD_VideoProcessor_GetVideoProcessBltState_Proxy(
    IDXVAHD_VideoProcessor* This,
    DXVAHD_BLT_STATE State,
    UINT DataSize,
    void *pData);
void __RPC_STUB IDXVAHD_VideoProcessor_GetVideoProcessBltState_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDXVAHD_VideoProcessor_SetVideoProcessStreamState_Proxy(
    IDXVAHD_VideoProcessor* This,
    UINT StreamNumber,
    DXVAHD_STREAM_STATE State,
    UINT DataSize,
    const void *pData);
void __RPC_STUB IDXVAHD_VideoProcessor_SetVideoProcessStreamState_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDXVAHD_VideoProcessor_GetVideoProcessStreamState_Proxy(
    IDXVAHD_VideoProcessor* This,
    UINT StreamNumber,
    DXVAHD_STREAM_STATE State,
    UINT DataSize,
    void *pData);
void __RPC_STUB IDXVAHD_VideoProcessor_GetVideoProcessStreamState_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDXVAHD_VideoProcessor_VideoProcessBltHD_Proxy(
    IDXVAHD_VideoProcessor* This,
    IDirect3DSurface9 *pOutputSurface,
    UINT OutputFrame,
    UINT StreamCount,
    const DXVAHD_STREAM_DATA *pStreams);
void __RPC_STUB IDXVAHD_VideoProcessor_VideoProcessBltHD_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
