/*** Autogenerated by WIDL 1.6 from ../src/d3d11/dxgi1_4.idl - Do not edit ***/
...
HRESULT STDMETHODCALLTYPE IDXGIFactory4_EnumAdapterByLuid_Proxy(
    IDXGIFactory4* This,
    LUID AdapterLuid,
    REFIID riid,
    void **ppvAdapter);
void __RPC_STUB IDXGIFactory4_EnumAdapterByLuid_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDXGIFactory4_EnumWarpAdapter_Proxy(
    IDXGIFactory4* This,
    REFIID riid,
    void **ppvAdapter);
void __RPC_STUB IDXGIFactory4_EnumWarpAdapter_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
/*** IDXGIOutput3 methods ***/
#define IDXGIOutput4_CheckOverlaySupport(This,format,device,flags) (This)->lpVtbl->CheckOverlaySupport(This,format,device,flags)
/*** IDXGIOutput4 methods ***/
...
/*** IDXGIOutput3 methods ***/
static FORCEINLINE HRESULT IDXGIOutput4_CheckOverlaySupport(IDXGIOutput4* This,DXGI_FORMAT format,IUnknown *device,UINT *flags) {
...
HRESULT STDMETHODCALLTYPE IDXGIOutput4_CheckOverlayColorSpaceSupport_Proxy(
    IDXGIOutput4* This,
    DXGI_FORMAT Format,
    DXGI_COLOR_SPACE_TYPE ColorSpace,
    IUnknown *pConcernedDevice,
    UINT *pFlags);
void __RPC_STUB IDXGIOutput4_CheckOverlayColorSpaceSupport_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
